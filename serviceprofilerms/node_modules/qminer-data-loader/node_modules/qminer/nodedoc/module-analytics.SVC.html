      ...
      <div id="jsdoc-content-container">
        <div id="jsdoc-main" role="main">
          <header class="page-header">
            <h1><div class="symbol-detail-labels"><span class="label label-kind">class</span>&nbsp;<span class="label label-static">static</span></div><small><a href="module-analytics.html">analytics</a>.<wbr></small><span class="symbol-name">SVC</span></h1>
            <p class="source-link">Source: <a href="analyticsdoc.js.html#source-line-83">analyticsdoc.<wbr>js:83</a></p>
            <div class="symbol-classdesc">
              <p>Support Vector Machine Classifier. Implements a soft margin linear support vector classifier using the PEGASOS algorithm, see: <a href="http://ttic.uchicago.edu/~nati/Publications/PegasosMPB.pdf">Pegasos: Primal Estimated sub-GrAdient SOlver for SVM</a>.</p>
            </div>
            <dl class="dl-compact">
            </dl>
          </header>
...
var prediction = SVC.predict(test);</code></pre>
              ...
              <table class="jsdoc-details-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <p>(<a href="module-fs.FIn.html">module:fs.FIn</a> or <a href="module-analytics.html#~svcParam">module:analytics~svcParam</a>)</p>
                    </td>
                    <td>
                      <p>Yes</p>
                    </td>
                    <td>
                      <p>File input stream (loads the model from disk) or constructor parameters svcParam.</p>
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <section>
            ...
            <section>
              ...
              <p>Gets the vector of coefficients of the linear model.</p>
              <section>
                <h4>
            Example
        </h4>
...
var weights = SVC.weights; // returns the coefficients of the normal vector of the hyperplane gained from the model: [1, 1]</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-la.Vector.html">module:la.Vector</a></code>&nbsp;weights - Vector of coefficients of the linear model.</p>
                </dd>
              </dl>
            </section>
            <h2>Methods</h2>
...
var distance = SVC.decisionFunction(vec2); // returns something close to 5</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>(number or <a href="module-la.Vector.html">module:la.Vector</a>)</code>&nbsp;Distance:
                    <br>1. Real number, if input is <a href="module-la.Vector.html">module:la.Vector</a> or <a href="module-la.SparseVector.html">module:la.SparseVector</a>.
                    <br>2. <a href="module-la.Vector.html">module:la.Vector</a>, if input is <a href="module-la.Matrix.html">module:la.Matrix</a> or <a href="module-la.SparseMatrix.html">module:la.SparseMatrix</a>.
                    <br>Sign of the number corresponds to the class and the magnitude corresponds to the distance from the margin (certainty).</p>
                </dd>
              </dl>
              <h3 id="fit"><span class="symbol-name">fit</span><span class="signature"><span class="signature-params">(X, y)</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-analytics.SVC.html">module:analytics.SVC</a></span></span></h3>
...
SVC.fit(matrix, vec); // creates a model, where the hyperplane has the normal semi-equal to [1, 1]</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-analytics.SVC.html">module:analytics.SVC</a></code>&nbsp;Self.</p>
                </dd>
              </dl>
              <h3 id="getModel"><span class="symbol-name">getModel</span><span class="signature"><span class="signature-params">()</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-analytics.html#~svmModel">module:analytics~svmModel</a></span></span></h3>
              <p>Get the model.</p>
              <section>
                <h4>
            Example
...
var model = SVC.getModel(); // returns { weight: new require(&#x27;qminer&#x27;).la.Vector(); }</code></pre>
                </div>
              </section>
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-analytics.html#~svmModel">module:analytics~svmModel</a></code>&nbsp;The current SVM model.</p>
                </dd>
              </dl>
              <h3 id="getParams"><span class="symbol-name">getParams</span><span class="signature"><span class="signature-params">()</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-analytics.html#~svcParam">module:analytics~svcParam</a></span></span></h3>
              <p>Returns the SVC parameters.</p>
              <section>
                <h4>
            Example
        </h4>
...
var json = SVC.getParams(); </code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-analytics.html#~svcParam">module:analytics~svcParam</a></code>&nbsp;Parameters of the classifier model.</p>
                </dd>
              </dl>
...
var prediction = SVC.predict(vec2); // returns 1</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>(number or <a href="module-la.Vector.html">module:la.Vector</a>)</code>&nbsp;Prediction:
                    <br>1. Real number, if input is <a href="module-la.Vector.html">module:la.Vector</a> or <a href="module-la.SparseVector.html">module:la.SparseVector</a>.
                    <br>2. <a href="module-la.Vector.html">module:la.Vector</a>, if input is <a href="module-la.Matrix.html">module:la.Matrix</a> or <a href="module-la.SparseMatrix.html">module:la.SparseMatrix</a>.
                    <br>1 for positive class and -1 for negative.</p>
                </dd>
              </dl>
...
var SVC2 = new analytics.SVC(fin);	</code></pre>
              ...
              <h3 id="setParams"><span class="symbol-name">setParams</span><span class="signature"><span class="signature-params">(param)</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-analytics.SVC.html">module:analytics.SVC</a></span></span></h3>
                ...
                <table class="jsdoc-details-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p><a href="module-analytics.html#~svcParam">module:analytics~svcParam</a></p>
                      </td>
                      <td>
                        <p>&nbsp;</p>
                      </td>
