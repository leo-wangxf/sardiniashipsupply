      ...
      <div id="jsdoc-content-container">
        <div id="jsdoc-main" role="main">
          <header class="page-header">
            <h1><div class="symbol-detail-labels"><span class="label label-kind">class</span>&nbsp;<span class="label label-static">static</span></div><small><a href="module-analytics.html">analytics</a>.<wbr></small><span class="symbol-name">SVR</span></h1>
            <p class="source-link">Source: <a href="analyticsdoc.js.html#source-line-256">analyticsdoc.<wbr>js:256</a></p>
...
var prediction = SVR.predict(test);</code></pre>
              ...
              <table class="jsdoc-details-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <p>(<a href="module-fs.FIn.html">module:fs.FIn</a> or <a href="module-analytics.html#~svrParam">module:analytics~svrParam</a>)</p>
                    </td>
                    <td>
                      <p>Yes</p>
                    </td>
          ...
          <section>
            ...
            <section>
              ...
              <p>The vector of coefficients of the linear model.</p>
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
              ...
              <dl class="dl-compact">
                ...
                <dd>
                  <p><code>(number or <a href="module-la.Vector.html">module:la.Vector</a>)</code>&nbsp;Distance:
                    ...
                    <br>2. <a href="module-la.Vector.html">module:la.Vector</a>, if input is <a href="module-la.Matrix.html">module:la.Matrix</a> or <a href="module-la.SparseMatrix.html">module:la.SparseMatrix</a>.</p>
                </dd>
              </dl>
              <h3 id="fit"><span class="symbol-name">fit</span><span class="signature"><span class="signature-params">(X, y)</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-analytics.SVR.html">module:analytics.SVR</a></span></span></h3>
              <p>fits an SVM regression model, given column examples in a matrix and vector of targets</p>
              <section>
                <h4>
            Example
        </h4>
...
SVR.fit(matrix, vector);</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-analytics.SVR.html">module:analytics.SVR</a></code>&nbsp;Self.</p>
                </dd>
              </dl>
...
var model = SVR.getModel(); // returns { weights: new require(&#x27;qminer&#x27;).la.Vector(); }</code></pre>
                </div>
              </section>
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-analytics.html#~svmModel">module:analytics~svmModel</a></code>&nbsp;Get current SVM model</p>
                </dd>
              </dl>
              <h3 id="getParams"><span class="symbol-name">getParams</span><span class="signature"><span class="signature-params">()</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-analytics.html#~svrParam">module:analytics~svrParam</a></span></span></h3>
              <p>Returns the SVR parameters.</p>
              <section>
                <h4>
            Example
        </h4>
...
var params = SVR.getParams();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-analytics.html#~svrParam">module:analytics~svrParam</a></code>&nbsp;Parameters of the regression model.</p>
                </dd>
              </dl>
...
var SVR2 = new analytics.SVR()</code></pre>
                </div>
              </section>
              <section>
                <h4>Parameter</h4>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-fs.FOut.html">module:fs.FOut</a></code>&nbsp;Output stream.</p>
                </dd>
              </dl>
              <h3 id="setParams"><span class="symbol-name">setParams</span><span class="signature"><span class="signature-params">(param)</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-analytics.SVR.html">module:analytics.SVR</a></span></span></h3>
                ...
                <table class="jsdoc-details-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p><a href="module-analytics.html#~svrParam">module:analytics~svrParam</a></p>
                      </td>
                      <td>
                        <p>&nbsp;</p>
                      </td>
