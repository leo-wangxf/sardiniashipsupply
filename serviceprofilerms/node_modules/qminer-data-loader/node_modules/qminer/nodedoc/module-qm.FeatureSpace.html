      ...
      <div id="jsdoc-content-container">
        <div id="jsdoc-main" role="main">
          <header class="page-header">
            ...
            <p class="source-link">Source: <a href="qminerdoc.js.html#source-line-2435">qminerdoc.<wbr>js:2435</a></p>
          ...
          <section>
            <h2 id="FeatureSpace">new&nbsp;<span class="symbol-name">FeatureSpace</span><span class="signature"><span class="signature-params">(base, param)</span></span></h2>
            <p>Feature Space</p>
            <section>
              <h3>
            Example
...
base.close();</code></pre>
              ...
              <table class="jsdoc-details-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <p>(Array of Object or <a href="module-fs.FIn.html">module:fs.FIn</a>)</p>
                    </td>
                    <td>
                      <p>&nbsp;</p>
                    </td>
                    <td>
                      <p>Array with definiton of extractors or input stream.</p>
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <section>
            ...
            <section>
              ...
              <p>Returns the dimension of the feature space.</p>
              <dl class="dl-compact">
              </dl>
              <h3 id="dims"><span class="symbol-name">dims</span></h3>
              <p>Returns an array of the dimensions of each feature extractor in the feature space.</p>
              <dl class="dl-compact">
              </dl>
            </section>
            <h2>Methods</h2>
            <section>
              <h3 id="addFeatureExtractor"><span class="symbol-name">addFeatureExtractor</span><span class="signature"><span class="signature-params">(obj)</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-qm.FeatureSpace.html">module:qm.FeatureSpace</a></span></span></h3>
                ...
                <table class="jsdoc-details-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p>The added feature extractor. It must be given as a JSON object.</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
base.close();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-la.Matrix.html">module:la.Matrix</a></code>&nbsp;The dense matrix, where the i-th column is the feature vector of the i-th record in rs.</p>
                </dd>
              </dl>
              <h3 id="extractSparseMatrix"><span class="symbol-name">extractSparseMatrix</span><span class="signature"><span class="signature-params">(rs[, featureExtractorId])</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-la.SparseMatrix.html">module:la.SparseMatrix</a></span></span></h3>
...
base.close();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-la.SparseMatrix.html">module:la.SparseMatrix</a></code>&nbsp;The sparse matrix, where the i-th column is the sparse feature vector of the i-th record in rs.</p>
                </dd>
              </dl>
              <h3 id="extractSparseVector"><span class="symbol-name">extractSparseVector</span><span class="signature"><span class="signature-params">(rec[, featureExtractorId])</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-la.SparseVector.html">module:la.SparseVector</a></span></span></h3>
...
base.close();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-la.SparseVector.html">module:la.SparseVector</a></code>&nbsp;The sparse feature vector gained from rec.</p>
                </dd>
              </dl>
              <h3 id="extractVector"><span class="symbol-name">extractVector</span><span class="signature"><span class="signature-params">(rec[, featureExtractorId])</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-la.Vector.html">module:la.Vector</a></span></span></h3>
...
base.close();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-la.Vector.html">module:la.Vector</a></code>&nbsp;The feature vector gained from rec.</p>
                </dd>
              </dl>
...
base.close();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>(<a href="module-la.Vector.html">module:la.Vector</a> or <a href="module-la.SparseVector.html">module:la.SparseVector</a>)</code>&nbsp;
                    <br>1. module:la.Vector, if vec is of type module:la.Vector.
                    <br>2. module:la.SparseVector, if vec is of type module:la.SparseVector.</p>
                </dd>
              </dl>
...
base.close();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>String</code>&nbsp;The name of the feature at the position idx.</p>
                </dd>
              </dl>
...
base.close();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>String</code>&nbsp;The name of the feature extractor at position idx.</p>
                </dd>
              </dl>
...
base.close();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>Object</code>&nbsp;The inverse of val using the feature extractor with index idx.</p>
                </dd>
              </dl>
              <h3 id="invertFeatureVector"><span class="symbol-name">invertFeatureVector</span><span class="signature"><span class="signature-params">(ftr)</span>&nbsp;&rarr; <span class="signature-returns"> Array</span></span></h3>
...
base.close();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>Array</code>&nbsp;The inverse of ftr as an Array.</p>
                </dd>
              </dl>
