      ...
      <div id="jsdoc-content-container">
        <div id="jsdoc-main" role="main">
          <header class="page-header">
            ...
            <p class="source-link">Source: <a href="analyticsdoc.js.html#source-line-3222">analyticsdoc.<wbr>js:3222</a></p>
              ...
              <div class="summary-content">
                ...
                <div class="summary-column">
                  <dl class="dl-summary-callout">
                    ...
                    <dt><a href="module-analytics.PCA.html#setParams">setParams(Object)</a></dt>
                    <dd>
                    </dd>
                  </dl>
                </div>
          ...
          <section>
            <h2 id="PCA">new&nbsp;<span class="symbol-name">PCA</span><span class="signature"><span class="signature-params">([params])</span></span></h2>
            <section>
              <h3>
            Examples
        </h3>
              ...
              <table class="jsdoc-details-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <p>(<a href="module-analytics.html#~pcaParams">module:analytics~pcaParams</a> or <a href="module-fs.FIn.html">module:fs.FIn</a>)</p>
                    </td>
                    <td>
                      <p>Yes</p>
                    </td>
...
var model = pca.getModel();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>Object</code>&nbsp;The model object whose keys are: P (eigenvectors), lambda (eigenvalues) and mu (mean)</p>
                </dd>
              </dl>
              <h3 id="getParams"><span class="symbol-name">getParams</span><span class="signature"><span class="signature-params">()</span></span></h3>
              <p>Gets parameters</p>
              <section>
                <h4>
            Examples
...
var paramvalue = pca.getParams();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p>Object whose keys are: k (number of eigenvectors) and iter (maximum iterations)</p>
                </dd>
              </dl>
              <h3 id="inverseTransform"><span class="symbol-name">inverseTransform</span><span class="signature"><span class="signature-params">(x)</span>&nbsp;&rarr; <span class="signature-returns"> (<a href="module-la.Vector.html">module:la.Vector</a> or <a href="module-la.Matrix.html">module:la.Matrix</a>)</span></span></h3>
...
var invTransform = pca.inverseTransform(vector);</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>(<a href="module-la.Vector.html">module:la.Vector</a> or <a href="module-la.Matrix.html">module:la.Matrix</a>)</code>&nbsp;Returns the reconstruction</p>
                </dd>
              </dl>
...
pca.save(require(&#x27;qminer&#x27;).fs.openWrite(&#x27;pca_test.bin&#x27;)).close();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-fs.FOut.html">module:fs.FOut</a></code>&nbsp;The given output stream fout.</p>
                </dd>
              </dl>
              <h3 id="setParams"><span class="symbol-name">setParams</span><span class="signature"><span class="signature-params">(Object)</span></span></h3>
              <p>Sets parameters</p>
              <section>
                <h4>
            Example
...
pca.setParams({iter: 10, k: 5});</code></pre>
                ...
                <table class="jsdoc-details-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p>whose keys are: k (number of eigenvectors) and iter (maximum iterations)</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <h3 id="transform"><span class="symbol-name">transform</span><span class="signature"><span class="signature-params">(x)</span>&nbsp;&rarr; <span class="signature-returns"> (<a href="module-la.Vector.html">module:la.Vector</a> or <a href="module-la.Matrix.html">module:la.Matrix</a>)</span></span></h3>
              <p>Projects the example(s) and expresses them as coefficients in the eigenvector basis this.P. Recovering the data in the original space: (this.P).multiply(p), where p's rows are the coefficients in the eigenvector basis.</p>
              <section>
                <h4>
            Examples
        </h4>
...
var transform = pca.transform(vector);</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>(<a href="module-la.Vector.html">module:la.Vector</a> or <a href="module-la.Matrix.html">module:la.Matrix</a>)</code>&nbsp;Returns projected vector or matrix</p>
                </dd>
              </dl>
            </section>
          </section>
