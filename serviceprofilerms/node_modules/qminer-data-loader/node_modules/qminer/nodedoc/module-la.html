...
var arr = la.copyVecToArray(vec); // returns an array [1, 2, 3]</code></pre>
              ...
              <h3 id=".findMaxIdx"><div class="symbol-detail-labels"><span class="label label-static">static</span></div><span class="symbol-name">findMaxIdx</span><span class="signature"><span class="signature-params">(X)</span>&nbsp;&rarr; <span class="signature-returns"> Array of number</span></span></h3>
...
// [1, 0]</code></pre>
                ...
                <table class="jsdoc-details-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p>(la.Matrix or la.Vector)</p>
                      </td>
                      <td>
                        <p>&nbsp;</p>
                      </td>
                      <td>
                        <p>A matrix or a vector</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>Array of number</code>&nbsp;Array of indexes where maximum is found, one for each column</p>
                </dd>
              </dl>
...
var vec = la.ones(3);</code></pre>
              ...
              <h3 id=".pdist2"><div class="symbol-detail-labels"><span class="label label-static">static</span></div><span class="symbol-name">pdist2</span><span class="signature"><span class="signature-params">(X1, X2)</span>&nbsp;&rarr; <span class="signature-returns"> la.Matrix</span></span></h3>
...
// 1 2.5 5</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>la.Matrix</code>&nbsp;Matrix with <code>X1.cols</code> rows and <code>X2.cols</code> columns containing squared euclidiean distances.</p>
                </dd>
              </dl>
              <h3 id=".randi"><div class="symbol-detail-labels"><span class="label label-static">static</span></div><span class="symbol-name">randi</span><span class="signature"><span class="signature-params">(num[, len])</span>&nbsp;&rarr; <span class="signature-returns"> (number or la.IntVector)</span></span></h3>
                ...
                <table class="jsdoc-details-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <p>The number of integers. Must be an integer.</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>(number or la.IntVector)</code>&nbsp;
                    <br>1. Randomly selected integer from the array [0, ..., num-1], if no parameters are given.
                    <br>2. <a href="module-la.Vector.html">module:la.Vector</a>, if parameter len is given. The vector contains random integers from the array [0, ..., num-1] (with repetition)</p>
                </dd>
              </dl>
              ...
              <h3 id=".rangeVec"><div class="symbol-detail-labels"><span class="label label-static">static</span></div><span class="symbol-name">rangeVec</span><span class="signature"><span class="signature-params">(min, max)</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-la.IntVector.html">module:la.IntVector</a></span></span></h3>
...
// 1  2  3</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-la.IntVector.html">module:la.IntVector</a></code>&nbsp;Integer range vector</p>
                </dd>
              </dl>
              ...
              <h3 id="qr"><span class="symbol-name">qr</span><span class="signature"><span class="signature-params">(mat[, tol])</span>&nbsp;&rarr; <span class="signature-returns"> Object</span></span></h3>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>Object</code>&nbsp;A JSON object qrRes which contains the decomposition matrices:
                    <br>qrRes.Q - The orthogonal dense matrix Q of the QR decomposition. Type <a href="module-la.Matrix.html">module:la.Matrix</a>.
                    <br>qrRes.R - The upper triangular dense matrix R of the QR decomposition. Type <a href="module-la.Matrix.html">module:la.Matrix</a>.</p>
                </dd>
              </dl>
              <h3 id="svd"><span class="symbol-name">svd</span><span class="signature"><span class="signature-params">(mat, k[, json][, callback])</span>&nbsp;&rarr; <span class="signature-returns"> Object</span></span></h3>
              <p>Computes the truncated SVD decomposition.</p>
              <section>
                <h4>
            Examples
        </h4>
...
var s = result.s;</code></pre>
                ...
                <table class="jsdoc-details-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <p>The number of singular vectors to be computed.</p>
                      </td>
                    </tr>
                    <tr>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <p>The callback function, that takes the error parameters (err) and the result parameter (res).
                          <i>Only for the asynchronous function.</i></p>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>Object</code>&nbsp;The JSON object svdRes which contains the SVD decomposition U<em>S</em>V^T matrices:
                    <br>svdRes.U - The dense matrix of the decomposition. Type <a href="module-la.Matrix.html">module:la.Matrix</a>.
                    <br>svdRes.V - The dense matrix of the decomposition. Type <a href="module-la.Matrix.html">module:la.Matrix</a>.
                    <br>svdRes.s - The vector containing the singular values of the decomposition. Type <a href="module-la.Vector.html">module:la.Vector</a>.</p>
                </dd>
              </dl>
            </section>
