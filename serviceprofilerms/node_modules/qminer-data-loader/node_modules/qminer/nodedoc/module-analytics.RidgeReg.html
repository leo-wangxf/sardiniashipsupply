      ...
      <div id="jsdoc-content-container">
        <div id="jsdoc-main" role="main">
          <header class="page-header">
            <h1><div class="symbol-detail-labels"><span class="label label-kind">class</span>&nbsp;<span class="label label-static">static</span></div><small><a href="module-analytics.html">analytics</a>.<wbr></small><span class="symbol-name">RidgeReg</span></h1>
            <p class="source-link">Source: <a href="analyticsdoc.js.html#source-line-411">analyticsdoc.<wbr>js:411</a></p>
            <dl class="dl-compact">
            </dl>
          </header>
          <section id="summary">
          ...
          <section>
            ...
            <p>Ridge regression. Minimizes: ||A' x - b||^2 + ||gamma x||^2</p>
            <p>Uses <a href="http://en.wikipedia.org/wiki/Tikhonov_regularization">Tikhonov regularization</a>.</p>
            <section>
              <h3>
            Example
        </h3>
              ...
              <table class="jsdoc-details-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <p>Loads a model from input stream, or creates a new model by setting gamma=arg from a Json object. Empty constructor sets gamma to zero.</p>
                    </td>
                  </tr>
                </tbody>
              </table>
                ...
                <table class="jsdoc-details-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p>Vector of coefficients for linear regression.</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
var prediction = regmod.decisionFunction(vec);</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>number</code>&nbsp;Predicted response.</p>
                </dd>
              </dl>
              <h3 id="fit"><span class="symbol-name">fit</span><span class="signature"><span class="signature-params">(X, y)</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-analytics.RidgeReg.html">module:analytics.RidgeReg</a></span></span></h3>
...
regmod.fit(X, y);</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-analytics.RidgeReg.html">module:analytics.RidgeReg</a></code>&nbsp;Self. The model is fitted by X and y.</p>
                </dd>
              </dl>
              <h3 id="getModel"><span class="symbol-name">getModel</span><span class="signature"><span class="signature-params">()</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-analytics.html#~ridgeRegModel">module:analytics~ridgeRegModel</a></span></span></h3>
              <p>Gets the model.</p>
              <section>
                <h4>
            Example
...
var regmod = new analytics.RidgeReg();
// get the model
var model = regmod.getModel(); // returns { weights: new require(&#x27;qminer&#x27;).la.Vector(); }</code></pre>
                </div>
              </section>
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-analytics.html#~ridgeRegModel">module:analytics~ridgeRegModel</a></code>&nbsp;Get current model.</p>
                </dd>
              </dl>
...
var param = regmod.getParams();</code></pre>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code>Object</code>&nbsp;The Json object containing the parameters.</p>
                </dd>
              </dl>
...
var regmod2 = new analytics.RidgeReg(fin);</code></pre>
              ...
              <h3 id="setParams"><span class="symbol-name">setParams</span><span class="signature"><span class="signature-params">(gamma)</span>&nbsp;&rarr; <span class="signature-returns"> <a href="module-analytics.RidgeReg.html">module:analytics.RidgeReg</a></span></span></h3>
...
var param = regmod.setParams({ gamma: 10 });</code></pre>
                ...
                <table class="jsdoc-details-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p>The new parameter for the model, given as a number or as a json object.</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <dl class="dl-compact">
                <dt>Returns</dt>
                <dd>
                  <p><code><a href="module-analytics.RidgeReg.html">module:analytics.RidgeReg</a></code>&nbsp;Self. The parameter is set to gamma.</p>
                </dd>
              </dl>
            </section>
          </section>
