...
$(srcdir)/out/qm.node: TOOLSET := $(TOOLSET)
$(srcdir)/out/qm.node: $(builddir)/qm.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(srcdir)/out/qm.node
binding_gyp_action_after_build_target_copies = $(srcdir)/out/qm.node
...
$(binding_gyp_action_after_build_target_copies): | $(builddir)/qm.node

$(obj).target/action_after_build.stamp: TOOLSET := $(TOOLSET)
$(obj).target/action_after_build.stamp: $(builddir)/qm.node FORCE_DO_CMD
	$(call do_cmd,touch)
